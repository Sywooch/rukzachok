...
$this->title = 'Регистрация Исполнителя - Компания';
...
<div class="col-md-6 col-md-offset-3">
    ...
    <div class="alert alert-info">Потратив пару минут для регистрации на Бычок, вы сможете создавать услуги и находить заказчиков.</div>
